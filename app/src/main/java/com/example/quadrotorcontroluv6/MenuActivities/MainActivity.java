...
import com.example.quadrotorcontroluv6.Utils.PermissionsRequest;
...
//********************************
       ...
       // TextView resulsuma = (TextView) findViewById(R.id.suma);
        //resulsuma.setText(SUMA((float) 4.465, (float) 55.77));
        //resulsuma.setText(Double.toString(MULTI()));
        //**************************************
    ...
    //tv.setText(stringFromJNI());
       ...
       //     EKF.initEKF(1.568, 0.0135, 0.0124, 0.0336);
    ...
    //public native String SUMA(float a, float b);
